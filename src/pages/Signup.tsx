  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(Array.isArray(errData.detail) ? errData.detail[0].msg : errData.detail || 'Signup failed')
      }
    } catch {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
           <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest text-primary/60 ml-2">Full Name</label>
            <Input
